...
mod test {
    ...
    const SPARQL_BASE: &str = r#"BASE <http://example.org/data/>"#;
    const SPARQL_PREFIX: &str = r#"PREFIX rdf:  <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"#;
    const TRIPLES: &str = r#"<rangefinder/30>        rdf:type           sosa:Sensor ;
        rdfs:label "rangefinder #30"@en ;
        rdfs:comment "rangefinder #30 is a laser range finder sensor."@en ."#;

    #[test_case(FULL_DOC, Rule::turtleDoc => true ; "turtle_doc")]
    ...
    #[test_case(SPARQL_BASE, Rule::sparqlBase => true ; "sparql_base")]
    #[test_case(SPARQL_PREFIX, Rule::sparqlPrefix => true ; "sparql_prefix")]
    #[test_case(TRIPLES, Rule::triples => true ; "triples")]
